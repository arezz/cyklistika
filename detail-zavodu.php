...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <table>
          <tr><td style="vertical-align:bottom; height:50px;"><a href="vypis-zavodu.php">Zpět na výpis závodů</a></td><td colspan="3" style="text-align:center; vertical-align:bottom;"><h1>Seznam přihlášených</h1></td><td style="text-align:right; vertical-align:bottom;"><form action="detail-zavodu.php?zavod=<?php echo $zavod; ?>"><?php include("detail-zavodu-combobox-kategorie.php"); ?></form></td></tr>
          <tr>
            <td>&nbsp;</td>
            <td colspan="3">
                 <?php
