      ...
      <div class="content">
        ...
        <?php 
	      ...
	      $pocetZavodniku=$zaznam["total_racers"];
            ...
            if ($pocetZavodu === 0) {
            	echo "<tr><td colspan=\"4\" style=\"text-align:center;\"><h3>Sezona 2004 - bez účasti</h3></td>";
            }
            // 2004 -----------------------------------------------------------
	      ...
	      $pocetZavodniku=$zaznam["total_racers"];
              ...
              echo "<tr><td style=\"text-align:right; padding-right:15px;\">Kategorie:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$category - $categoryName</b></td>
              	    <td style=\"text-align:right; padding-right:15px;\">Součet bodů (7 NEJ / celkem):</td>
                    <td style=\"text-align:left; padding-left:15px;\"><b>$totalPointsBest / $totalPoints</b></td></tr>";
              echo "<tr><td style=\"text-align:right; padding-right:15px;\">Konečné umístění:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$umisteniVKategorii. / $pocetZavodniku</b></td>
              		<td style=\"text-align:right; padding-right:15px;\">Nejlepší umístění:</td>
            ...
            if ($pocetZavodu === 0) {
            	echo "<tr><td colspan=\"4\" style=\"text-align:center;\"><h3>Sezona 2003 - bez účasti</h3></td>";
            }
            // 2003 -----------------------------------------------------------
            ...
            while ($zaznam = MySQL_Fetch_Array($vysledek))
            {
              ...
              echo "<tr><td style=\"text-align:right; padding-right:15px;\">Oddíl:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$team</b></td>
              		<td style=\"text-align:right; padding-right:15px;\">Konečné umístění:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$umisteniVKategorii. / $pocetZavodniku</b></td>";
              echo "<tr><td style=\"text-align:right; padding-right:15px;\">Kategorie:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$category - $categoryName</b></td>
              	    <td style=\"text-align:right; padding-right:15px;\">Celkem bodů:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$totalPoints</b></td></tr>";
            }
            if ($pocetZavodu === 0 && $totalPoints === 0) {
            	echo "<tr><td colspan=\"4\" style=\"text-align:center;\"><h3>Sezona 2002 - bez účasti</h3></td>";
            }
            // 2002 -----------------------------------------------------------
            ...
            if ($pocetZavodu === 0 && $totalPoints === 0) {
            	echo "<tr><td colspan=\"4\" style=\"text-align:center;\"><h3>Sezona 2001 - bez účasti</h3></td>";
            }
            // 2001 -----------------------------------------------------------
	      ...
	      $pocetZavodniku=$zaznam["total_racers"];
              ...
              echo "<tr><td style=\"text-align:right; padding-right:15px;\">Kategorie:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$category - $categoryName</b></td>
              	    <td style=\"text-align:right; padding-right:15px;\">Součet bodů (12 NEJ / celkem):</td>
                    <td style=\"text-align:left; padding-left:15px;\"><b>$totalPointsBest / $totalPoints</b></td></tr>";
              echo "<tr><td style=\"text-align:right; padding-right:15px;\">Konečné umístění:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$umisteniVKategorii. / $pocetZavodniku</b></td>
              		<td style=\"text-align:right; padding-right:15px;\">Nejlepší umístění:</td>
            ...
            if ($pocetZavodu === 0) {
            	echo "<tr><td colspan=\"4\" style=\"text-align:center;\"><h3>Sezona 2000 - bez účasti</h3></td>";
            }
            // 2000 -----------------------------------------------------------
	      ...
	      $pocetZavodniku=$zaznam["total_racers"];
              ...
              echo "<tr><td style=\"text-align:right; padding-right:15px;\">Kategorie:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$category - $categoryName</b></td>
              	    <td style=\"text-align:right; padding-right:15px;\">Součet bodů (6 NEJ / celkem):</td>
                    <td style=\"text-align:left; padding-left:15px;\"><b>$totalPointsBest / $totalPoints</b></td></tr>";
              echo "<tr><td style=\"text-align:right; padding-right:15px;\">Konečné umístění:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$umisteniVKategorii. / $pocetZavodniku</b></td>";
            }
            if ($pocetZavodu === 0) {
            	echo "<tr><td colspan=\"4\" style=\"text-align:center;\"><h3>Sezona 1999 - bez účasti</h3></td>";
            }
            // 1999 -----------------------------------------------------------
	      ...
	      $pocetZavodniku=$zaznam["total_racers"];
              ...
              echo "<tr><td style=\"text-align:right; padding-right:15px;\">Kategorie:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$category - $categoryName</b></td>
              	    <td style=\"text-align:right; padding-right:15px;\">Součet bodů (8 NEJ / celkem):</td>
                    <td style=\"text-align:left; padding-left:15px;\"><b>$totalPointsBest / $totalPoints</b></td></tr>";
              echo "<tr><td style=\"text-align:right; padding-right:15px;\">Konečné umístění:</td>
                    <td style=\"text-align:left; color:#FF8F16; padding-left:15px;\"><b>$umisteniVKategorii. / $pocetZavodniku</b></td>";
            }
            if ($pocetZavodu === 0) {
            	echo "<tr><td colspan=\"4\" style=\"text-align:center;\"><h3>Sezona 1998 - bez účasti</h3></td>";
            }
            // 1998 -----------------------------------------------------------
