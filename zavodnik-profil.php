        ...
        <table>
          ...
          // 2011 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
            ...
            while ($zaznam = MySQL_Fetch_Array($vysledek))
            {
              ...
              echo "<tr><td colspan=\"2\" style=\"text-align:right; padding-right:15px;\">Konečné umístění:</td>
                    <td colspan=\"2\" style=\"text-align:left; padding-left:15px;\"><b>$umisteniVKategorii. / $pocetZavodniku</b></td></tr>";
              echo "<tr><td colspan=\"2\" style=\"text-align:right; padding-right:15px;\">Součet bodů (10 NEJ / celkem):</td>
                    <td colspan=\"2\" style=\"text-align:left; padding-left:15px;\"><b>$totalPointsBest / $totalPoints</b></td></tr>";
              echo "<tr><td colspan=\"2\" style=\"text-align:right; padding-right:15px;\">Počet dokončených závodů:</td>
                    <td colspan=\"2\" style=\"text-align:left; padding-left:15px;\"><b>$pocetZavodu / 18</b></td></tr>";
              echo "<tr><td colspan=\"2\" style=\"text-align:right; padding-right:15px;\">Nejlepší umístění:</td>
