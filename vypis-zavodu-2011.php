...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>SPAC - výpis závodů 2011</title>
    ...
    <div class="container">
      ...
      <div class="content">
        <table>
          ...
          <tr><td colspan="4" style="text-align:center; vertical-align:top; height:40px;">Pro seznam přihlášených závodníků klikněte na název závodu.</td></tr>
          <tr>
            <th>Datum závodu</th>
            <th>Název</th>
            <th>Místo</th>
          ...
          <?php 
            $dotaz="SELECT * FROM spac_race WHERE season=2011 ORDER BY id";
            ...
            if (($i % 2) & isset($_SESSION["administrace"]))
            {
              echo "<tr><td colspan='4'><span class='admin'><a href='pridat-zavod.php'>[přidat závod]</a></admin></td></tr>";
            }
            if (!($i % 2) & isset($_SESSION["administrace"]))
            {
              echo "<tr class='odd'><td colspan='4'><span class='admin'><a href='pridat-zavod.php'>[přidat závod]</a></admin></td></tr>";
            }
          ?>
        </table>
      </div>
