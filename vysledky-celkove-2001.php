...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <table>
          <tr><td colspan="32" style="text-align:center; vertical-align:bottom; height:50px;"><h1>Konečné celkové výsledky za rok 2001</h1></td></tr>
          <?php 
           echo "<tr>
            ...
            if ($id_category === -1) {
	            $dotaz="SELECT * FROM spac_results_2001 t
