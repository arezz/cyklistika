    ...
    <div class="container">    
      ...
      <div class="content">
        <form action="prihlaseni-zavodnika.php" method="post">      
          <table>        
            <tr><td colspan="2" style="text-align:center; vertical-align:bottom; height:50px;"><h1>Přihlášení závodníka</h1></td></tr>          
            ...
            <tr><td style="text-align:right; vertical-align:top;">Startovní číslo:&nbsp;</td><td style="text-align:left;"><input type="text" name="cislo" <?php writte("cislo"); ?>/> (pouze majitelé licencí)</td></tr>
            <tr><td style="text-align:right; vertical-align:top;">Kategorie:&nbsp;</td><td style="text-align:left;"><?php include("kategorie-prihlaseni-combobox.php"); errmsg("kategorie","Vyberte kategorii"); ?></td></tr>
