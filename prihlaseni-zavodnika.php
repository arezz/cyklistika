      ...
      <div class="content">
        <form action="prihlaseni-zavodnika.php" method="post">      
          <table>        
            ...
            <tr><td style="text-align:right; vertical-align:top;">Startovní číslo:&nbsp;</td><td style="text-align:left;"><input type="text" name="cislo" <?php writte("cislo"); ?>/> (pouze pro <a href="http://www.spac-os.cz/web/_docs/seznam_licenci_2012.xls">licencované</a>)</td></tr>
